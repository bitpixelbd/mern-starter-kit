...
import { Button, Card, Collapse, Form, Input, Tabs, Upload, message } from "antd";
...
import { getImageFieldsKeys, SETTINGS } from "~/pages/Settings/settings";
import TextArea from "antd/es/input/TextArea";
import General from "./_General";
import Images from "./_Images";
import SocialLink from "./_SocialLinks";
