...
export default function DifferenceBetweenAssesTedLiving() {
    ...
    return (
        <>
            <div className="difference-between-inner">
                <h1 className="headline-medium">What's the difference between assisted living and other senior care types?</h1>
                ...
                <div className="start-searching-care">
                    <h2 className="headline-small">Need help with finding perfect care home based on your specific preferences?</h2>
