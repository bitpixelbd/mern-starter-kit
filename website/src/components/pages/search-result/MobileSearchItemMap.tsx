...
export default function MobileSearchItemMap({ items, clickedItem, setSearchItems }: any) {
  ...
  return (
    ...
    <LoadScript
      googleMapsApiKey="AIzaSyC9pZst8ZQezGslmMbGe_Se_S4kaTP-eb0"
      libraries={libraries}
      // onLoad={onMapLoaded}
    >
      <GoogleMap
        ...
        {items?.map((item: any) => {
          return (
            ...
            >
              <div
                className={
                  activeCareHome && activeCareHome == item.id
                    ? "priceTagActive"
                    : "priceTag"
                }
                onClick={() => {
