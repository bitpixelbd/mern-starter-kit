...
export default function DrawerForm({ title, model, onClose, open, onSubmitSuccess, isEditing, editedItem, ...props }) {
    ...
    const updateData = useMutation(async (data: any) => await patch(getUrlForModel("partner", data.id), data), {//TODO refactor
        onSuccess: (response) => {
    ...
    const {
        ...
        queryFn: () => get(getUrlForModel("Advisor")),
    });
        ...
        <>
            <Drawer
                ...
                >
                    ...
                    <Form.Item label="Advisor" name="advisor_id">
                        <Select placeholder="advisor">
                            {
                                advisors?.data?.map(item =>
                                    <Select.Option value={item?.id} >{item?.id} - {item?.first_name} {item?.last_name}</Select.Option>
                                )
                            }
                        </Select>
                    </Form.Item>
